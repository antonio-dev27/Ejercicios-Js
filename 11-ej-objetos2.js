...
//haga un código que tenga la clase figura la cual: a. Tenga un constructor con el atributo de color. b. Tenga un método saludar e imprima en consola: “Hola! Soy una figura y mi color es color” c.        Cree una instancia de la clase e imprímala por consola.
...
class Figura {
  ...
  const nuevaFigura = new Figura("Azul");
  console.log(nuevaFigura.saludar());

  //Cree una clase cuadrado que herede de la clase figura la cual tenga los atributos de alto y ancho. Sobreescriba el método saludar con el siguiente mensaje: “Hola! Soy un cuadrado. Mi color es color y mis medidas son altoxancho” Cree una instancia de la clase cuadrado e imprímala por consola
  ...
  const nuevoCuadrado = new Cuadrado("Negro", 7, 5);
  
  console.log(nuevoCuadrado.saludar());

//Cree una clase circulo que herede de la clase figura la cual tenga el atributo de radio. Sobreescriba el método saludar con el siguiente mensaje: “Hola! Soy un cuadrado. Mi color es color y mi radio es radio” Cree una instancia de la clase circulo e imprímala por consola.
...
const figuraCirculo = new Circulo('Rojo', 14);
console.log(figuraCirculo.saludar());
